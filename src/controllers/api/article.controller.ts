...
export class ArticleController {
    ...
    //  POST http://localhost:3000/api/article/createFull/
    @Post('createFull') 
    ...
    @UseInterceptors(
        FileInterceptor('photo', {
            ...
            fileFilter: (req, file, callback) =>{
                ...
                // provera tipa sadržaja: image/jpg, img/png (mimetype)
    ...
    public async deletePhoto(
        ...
        @Param('photoId') photoId: number
            ...
            const photo = await this.photoService.findOne({ // pokušaj da nađeš konkretnu fotografiju sa sledećim parametrima
                articleId: articleId,
                photoId: photoId
            });
            ...
            const deleteResult = await this.photoService.deletById(photoId);
